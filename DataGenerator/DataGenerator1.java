...
public class DataGenerator {
        ...
        for (int i = 0; i < numOfFiles; ++i) { // prepare the data file
           ...
           // generate file name
            ...
            try {
                ...
                getDataInOneFile(deviceId, dolphindb_path, tdengine_path, rowsPerDevice, numOfDevPerFile, humidityDistRadius, tempDistRadius);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    private static void getDataInOneFile(int deviceId, String dolphindb_path, String tdengine_path, int rowsPerDevice, int num, int humidityDistRadius, int tempDistRadius) throws IOException {
    	int devId = deviceId;
